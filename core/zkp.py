...
from core.utils import pedersen_setup, pedersen_committ, pedersen_dec, ec_sum
...
class Damgard_Transfor(ZKP_Schnorr):
    ...
    def verify(slef, challenge, pedersen_open, pedersen_commit, stm, response):
        ...
        left_side = response * g
        right_side = (announce_element + challenge * stm)
        if left_side == right_side and pedersen_dec(slef.pp_pedersen, pedersen_open, pedersen_commit):
            return True
        return False
